...
require 'Magento/Test/Bootstrap.php';
require 'Utility/Classes.php';
...
/*
echo "Found root directory: " . realpath("$baseDir/../") . "\n";
echo "Found local XML file: " . $localXmlFile . "\n";
echo "Found global etc files: " . $globalEtcFiles . "\n";
echo "Found module etc files: " . $moduleEtcFiles . "\n";
echo "Found tmp dir: " . "$baseDir/tmp\n";
*/
